...
func (_m *MockDataSource) ExecuteCommand(args []interface{}, nodeID string) (interface{}, error) {
	ret := _m.ctrl.Call(_m, "ExecuteCommand", args, nodeID)
...
func (_mr *MockDataSourceMockRecorder) ExecuteCommand(arg0, arg1 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "ExecuteCommand", arg0, arg1)
}
